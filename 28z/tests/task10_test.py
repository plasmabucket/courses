...
class Task10Tests(unittest.TestCase):
    ...
    def test_regression(self) -> None:
        ...
        self.assertEqual(200, task10.PrintingCosts("Test string!"),
                         "Solution is incorrect.")

    def test_special_chars(self) -> None:
        """Tests solution on characters that could cause problems."""
        self.assertEqual(10, task10.PrintingCosts("\\"),
                         "Backslashes are unhandled.")
        self.assertEqual(3, task10.PrintingCosts("'"),
                         "Single quotes are unhandled.")
        self.assertEqual(6, task10.PrintingCosts('"'),
                         "Double quotes are unhandled.")
    ...
    def test_server_123(self) -> None:
        """Test for a case failed on the server."""
        self.assertEqual(19 + 22 + 23, task10.PrintingCosts('123'),
                         "Server test failed.")
